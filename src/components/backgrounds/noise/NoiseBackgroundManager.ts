/**
 * Base manager class for all noise background patterns
...
import type { BaseNoiseConfig, ColorsConfig } from './shaders/uniforms';
import { createBaseUniforms } from './shaders/uniforms';
import { vertexShader } from './shaders/vertex.glsl';

export interface NoiseBackgroundManagerConfig extends BaseNoiseConfig {
  [key: string]: unknown;
}

/**
 * Abstract base class for noise background managers
 * Subclasses must implement:
 * - getFragmentShader(): string
 * - createPatternUniforms(): Record<string, { value: unknown }>
 * - updatePatternUniforms(props): void
 */
export abstract class NoiseBackgroundManager<TConfig extends NoiseBackgroundManagerConfig = NoiseBackgroundManagerConfig> {
  ...
  protected parseBaseConfig(container: HTMLElement): BaseNoiseConfig {
    return {
