...
excerpt: "<p>I was coding when \"The Distance\" by Cake came on. <em>He's going the distance, he's going for speed...</em> And I thought: what if that was a Minecraft mod? What if the farther you traveled from spawn, the harder the game got? Not just a little harder. <strong>Exponentially, absurdly, ridiculously harder.</strong></p><p>So I built it. And thanks to my previous mutualism mod experience and Claude Code, what would've taken weeks happened in a few focused sessions. The implementation touches everything—mob health, spawn rates, damage scaling—but it's all variations on a single idea: distance equals difficulty.</p><p>Then came the playtesting. A friend and I loaded up the mod, built boats, and started exploring across oceans. At first, normal Minecraft. But as we traveled farther, the game revealed its teeth. Zombies started spawning <em>on our boats</em>. Not near us. Not in the water. Literally materializing on the boat we were riding. We died. A lot. And we laughed the entire time.</p><p>That's when I discovered something unexpected: this isn't really a single-player mod. Solo, the difficulty curve felt punishing. With a partner? Perfect. The escalating challenge became a shared adventure instead of personal frustration. So I tuned the scaling for co-op, and the mod became something way more interesting than I originally envisioned.</p>"
